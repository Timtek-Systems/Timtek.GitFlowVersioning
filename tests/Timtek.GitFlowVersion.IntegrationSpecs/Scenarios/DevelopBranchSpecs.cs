...
class when_develop_branch_is_ahead_of_tag_on_main : With_end_to_end_version_computation
{
    ...
    It should_produce_weighted_assembly_sem_ver = () => Context.Result.AssemblySemVer.ShouldEqual("1.3.0.8");
    It should_produce_weighted_assembly_file_ver = () => Context.Result.AssemblySemFileVer.ShouldEqual("1.3.0.8");
}
