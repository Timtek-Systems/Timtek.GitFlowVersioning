...
and `[assembly: AssemblyInformationalVersion]` attributes. The `.props` file disables
only these three SDK-generated version attributes to avoid conflicts, while leaving all
other standard attributes (`AssemblyConfiguration`, `AssemblyCompany`, `AssemblyProduct`,
etc.) generated by the SDK as normal.
