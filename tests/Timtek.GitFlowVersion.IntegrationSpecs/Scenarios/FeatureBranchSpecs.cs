...
class when_feature_branch_is_ahead_of_tag : With_end_to_end_version_computation
{
    ...
    It should_produce_weighted_assembly_sem_ver = () => Context.Result.AssemblySemVer.ShouldEqual("1.2.3.30011");
    It should_produce_weighted_assembly_file_ver = () => Context.Result.AssemblySemFileVer.ShouldEqual("1.2.3.30011");
}
